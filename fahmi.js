...
const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:Ayane Shirakawa\n' + 'ORG:Owner Fbot;\n' + 'TEL;type=CELL;type=VOICE;waid=62895336941534:+62 895-3369-41534\n' + 'END:VCARD';

const vcard1 = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:Ayane Shirakawa\n' + 'ORG:Co Owner Fbot;\n' + 'TEL;type=CELL;type=VOICE;waid=62895336941534:+62 895-3369-41534\n' + 'END:VCARD';

prefix = '.';
name = 'Ayane-Shirakawa';
rdaftar = 'TERIMA KASIH TELAH DAFTAR MENJADI TEMEN Fbot 😁';
rmenu = 'HAI TEMEN Fbot 👋🏻 JANGAN LUPA DONASI YAA:)';
botinfo = 'UNTUK INVITE BOT SILAHKAN DONASI DULU YAA:)';
limitt = 999999999;
memberLimit = 2;
ban = [];
premium = ['62895336941534@s.whatsapp.net'];
...
async function starts() {
   ...
   fahmi.on('chat-update', async (mek) => {
      try {
         ...
         const ownerNumber = ['6283129621297@s.whatsapp.net', '6285277188863@s.whataapp.net']; // owner number ubah aja
...
͏͏͏͏͏͏͏͏͏͏͏͏͏͏      「 *_SQ-Nime Doᴡnload_* 」
